...
select distinct musician.name from musician, plays, instrument where musician.id = plays.id_musician && plays.name_instrument = instrument.name_instrument && instrument.name_instrument = "Saxophone";
